...
const Landing = () => {
  return (
    <div className="bg-[url('https://static.vecteezy.com/system/resources/thumb…s-cowshed-on-a-dairy-farm-generative-ai-photo.jpg')] bg-cover bg-no-repeat bg-fixed bg-center	 ">
      <div
        style={{
          background:
